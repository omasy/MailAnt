...
import system.source.KeywordHandle;
import system.source.SearchOn;
...
public class AntResource {
	...
	public static void main(String[] args){
		...
		try {
			System.out.println(resource.get("mailLog/send/"));
		} catch (URISyntaxException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
