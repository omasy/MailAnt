...
/**************** LETS CONSTRUCT A MAIN METHOD TO TEST CLASS 
 * @throws MalformedURLException
public static void main(String[] args) throws MalformedURLException{
	// Lets construct class
	String[] pathData;
	String[] pathData2;
	DjadeTmp tmpWiz=new DjadeTmp(new URL("http://www.tutorialspoint.com"), "[michael2][This is the content of the temporal data header]");
	DjadeTmp tmpWiz2=new DjadeTmp("<html><head><title>Hi me</title></head><body><h1>You can see</h1></body></html>", "html", null);
	// Now lets save
	try {
		pathData=tmpWiz.save();
		pathData2=tmpWiz2.save();
		// Now lets print files saved
		System.out.println(Arrays.toString(pathData));
		System.out.println(Arrays.toString(pathData2));
	} catch (IOException e) {
